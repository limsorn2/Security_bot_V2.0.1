...
BLOCKED_EXTENSIONS = [".exe", ".apk", ".bat", ".scr", ".vbs", ".cmd", ".msi", ".jar", ".ps1", ".sh"]
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "/help - បង្ហាញជំនួយ\n"
        "/status - ពិនិត្យមើលស្ថានភាពប្រព័ន្ធសុវត្ថិភាព\n"
    ...
    if doc and doc.file_name:
        ...
        if any(file_name.endswith(ext) for ext in BLOCKED_EXTENSIONS):
            ...
            try:
                ...
                logger.info(f"🚫 បានលុបឯកសារគ្រោះថ្នាក់ {file_name} ពី {user_name}")
...
def main():
    logger.info("🚀 កំពុងចាប់ផ្តើម TeleGuard Bot Engine...")
